...
from layered_modelsolution import fit_mnist_model_single_digit, evaluate_mnist_model_single_digit
from layered_modelsolution import binarize_labels, get_mnist_data
...
def test_fit_and_predict_mnist_single_digit_one_neuron():
    ...
    print(f"Accuracy for digit 2: {accuracy}")
    ...
    print(f"Accuracy for digit 3: {accuracy}")
